...
*Table 4: Confusion Matrix for Males.*
...
*Table 5: Confusion Matrix for Females.*
...
| **Actual Positive** | 10 | 10 | 20 |
| **Actual Negative** | 2 | 38 | 40 |
*Table 7: New Confusion Matrix for Males*

| | Predicted Positive | Predicted Negative | Class Total
| --- | --- | --- | --- |
| **Actual Positive** | 18 | 9 | 27 |
| **Actual Negative** | 11 | 2 | 13 |
*Table 8: New Confusion Matrix for Females*
...
!!! tip "**Individual vs. Group Fairness**"
    ...
    his section is concerned with group-level fairness criteria, and the introduction of a tool that helps to decide between different definitions of group fairness.
