...
## Section 3: Defining Responsible Research and Innovation
...
!!! example inline  " "
  ...
  The algorithm optimises for engagement, i.e. how long people watch the videos recommended to them, and therefore recommends the videos which are deemed as most-likely to keep users engaged in the platform for the maximum of time possible.
...
!!! note 
  ...
  If you would like to know more about them, you can go to <!-- Link to Care & Act principles in AEG course and paper were they are first developed. -->
...
The related term 'technical debt' refers to the cost of the additional rework caused by choosing an easy soltuion now instead of a better approach that would take longer but avoid the lock-in.
