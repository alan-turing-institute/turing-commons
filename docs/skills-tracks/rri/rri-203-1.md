...
!!! info "**What do we mean by 'perspective'?**"
        ...
        Our use of the term 'perspective' is intended to draw attention to the fact that each of the them is focused on the same questions, but approaches the questions from a different stance or starting point.
...
These perspectives will form the basis of the remaining sections in this module.
