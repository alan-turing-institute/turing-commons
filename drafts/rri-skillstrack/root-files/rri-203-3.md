...
This graphic allows us to see where our model has classified patients as having the disease and not having the disease (i.e. the circle represents the model's decision boundary).
...
There are many more performance metrics that can be extracted from a confusion matrix than we will need for this section.
