...
This factor is akin to many of the factors that contribute to what is commonly referred to as the *digital divide*—a term that refers to the gap between those who have access to digital technologies and those who do not.

The digital divide can exist in many forms, including:
...
Many data-driven technologies sort and classify people into groups, and these groups (or buckets) are represented via a set of labels.
