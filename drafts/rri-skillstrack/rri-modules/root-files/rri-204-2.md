...
2. *Transparency is necessary for explainability*. The first team of lawyers will need to be able to explain the algorithm's structure in court in a way that is understandable to the judge and jury. Developing this explanation requires a certain degree of transparency in the documentation about how the algorithm was designed, developed, and deployed.
...
A team of data analysts are asked to explain a model they use for a travel booking company has drastically changed its predictions about customer booking behaviour.
...
- Identification and Mitigation of Biases: decisions about which biases are important for the project and why any chosen mitigation strategies are sufficient to address them
...
What other tasks can you think of, which may occur during one of the project lifecycle stages, that would require transparency? How would this transparency be achieved and how would it contribute to explaining any decisions or actions taken?
...
Firstly, while this section has proposed examples of mechanisms and processes for documenting and sharing information about a project and the associated tasks, it should be recognised that these tasks add additional resource demands.
