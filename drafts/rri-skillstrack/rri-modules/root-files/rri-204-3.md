...
By now you will have identified some of the benefits and limitations of model intepretability.
Let's embed this understanding in the context of responsible reseach and innovation.

### Understanding your data

While the term 'model inteprebaility methods' would suggest that the focus is on understanding the model itself, by now you will realise this is not always the case.
Rather, they can be a powerful tool for better understanding your data.
For instance, intepretable ML methods can:

- Provide imsights into which features are most important for forming predictions
...
As the above taxonomy demonstrates, not all methods are created equally and seletcing the right tool for the job remains an important maxim.
...
<!-- when embedded within a transparent approach to project governance, model interpretability can help affected users and stakeholders seek redress for any harms -->
